...
namespace Revert.Port.LibGDX.Mathematics.Vectors
{
    public class Vector3 : IVector<Vector3>
    {
        ...
        public Vector3(float x = 0f, float y = 0f, float z = 0)
        {
            this.x = x;
            this.y = y;
            this.z = z;
 ...
 * @param vector The vector */
        ...
        {
            float cosPolar = (float)Math.Cos(polarAngle);// MathUtils.cos(polarAngle);
            float sinPolar = (float)Math.Sin(polarAngle); //MathUtils.sin(polarAngle);

            float cosAzim = (float)Math.Cos(azimuthalAngle);
            float sinAzim = (float)Math.Sin(azimuthalAngle);
        ...
        {
            float u = Maths.randomFloat();
            float v = Maths.randomFloat();

            float theta = Maths.PI2 * u; // azimuthal angle
   ...
   //     }
        ...
        public bool isOnLine(Vector3 other)
        {
            return len2(y * other.z - z * other.y, z * other.x - x * other.z,
                x * other.y - y * other.x) <= Maths.FLOAT_ROUNDING_ERROR;
        }
        ...
        public bool equals(Object obj)
        {
            ...
            if (x.GetHashCode() != other.x.GetHashCode()) return false;
            if (y.GetHashCode() != other.y.GetHashCode()) return false;
            if (z.GetHashCode() != other.z.GetHashCode()) return false;
            return true;
        }
        ...
        {
            return epsilonEquals(other, Maths.FLOAT_ROUNDING_ERROR);
        }
        ...
        {
            return epsilonEquals(x, y, z, Maths.FLOAT_ROUNDING_ERROR);
        }
