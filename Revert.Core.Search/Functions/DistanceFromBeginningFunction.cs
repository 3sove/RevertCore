...
{
	internal class DistanceFromBeginningFunction : FunctionParser
	{
		public string FunctionName = "DISTANCEFROMBEGINNING";

		public Node Param_1;
		public int Distance;

		public static readonly DistanceFromBeginningFunction Parser = new DistanceFromBeginningFunction();

		private DistanceFromBeginningFunction() : base() { }

		private DistanceFromBeginningFunction(FunctionNode functionNode, Node param_1, int distance)
			: base(functionNode)
		{
			Param_1 = param_1;
			Distance = distance;
		...
		public override Node TryParse(FunctionNode functionNode, ErrorTrack ErrorTrack)
		{
			...
			{
				DistanceFromBeginningFunction distanceFromBeginningFunction = new DistanceFromBeginningFunction(functionNode, param_1, distance);

				distanceFromBeginningFunction.Children.Add(param_1);
				distanceFromBeginningFunction.Children.Add(distanceNode);

				return distanceFromBeginningFunction;
			}
			else
			{
